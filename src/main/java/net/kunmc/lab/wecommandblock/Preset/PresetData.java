...
public class PresetData implements Serializable {
    ...
    public PresetData(String type, Location origin, BlockVector3 pos1, Region region) {
        this.type = type;
        ...
        switch (type) {
            case "cuboid": {
                ...
                int[] d = {pos2.getX(), pos2.getY(), pos2.getZ()};
                this.pos2.add(d);
                break;
            }
            case "2Dx1D polygon": {
            ...
            case "ellipsoid": {
                ...
                int[] d = {this.pos1[0] + pos2.getX(), this.pos1[1] + pos2.getY(), this.pos1[2] + pos2.getZ()};
                this.pos2.add(d);
                break;
            }
            case "sphere": {
                EllipsoidRegion newRegion = ((EllipsoidRegion) region);
                BlockVector3 pos2 = newRegion.getRadius().toBlockPoint();
                int[] d = {this.pos1[0], this.pos1[1] + pos2.getY(), this.pos1[2]};
                this.pos2.add(d);
                break;
            }
            case "Cylinder": {
